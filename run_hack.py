...
model_path = 'DIR/llama/llama-2-7b-chat/consolidated.00.pth'
...
# Running the attack
# This following code implements a for-loop to demonstrate how that attack works. This implementation is based on our Github repo.
